...
const StackCard = ({ project, interactive }) => {
  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-white/[0.10] bg-gradient-to-b from-gradient-50 to-gradient-400 p-3 shadow-2xl shadow-black/50 sm:p-4">
      ...
      <div className="mt-4">
        ...
        <h3 className="mt-3 text-lg font-semibold leading-snug tracking-tight text-text-white">
          {interactive ? (
            <Link
        ...
        <p className="mt-2 line-clamp-2 text-sm leading-relaxed text-text-light-gray">
          {project.summary}
        </p>
